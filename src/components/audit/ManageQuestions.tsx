...
export function ManageQuestions({ internalQuestions, supplierQuestions, onUpdateInternal, onUpdateSupplier, onBack }: ManageQuestionsProps) {
  const [activeTab, setActiveTab] = useState<'INTERNAL' | 'SUPPLIER'>('INTERNAL');
  ...
  return (
    <div className="max-w-5xl mx-auto w-full pb-12">
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          <h1 className="text-2xl font-black text-slate-900">Manage Audit Questions</h1>
          <p className="text-sm font-medium text-slate-500">Add, edit, or remove evaluation questions</p>
        </div>
      </div>
