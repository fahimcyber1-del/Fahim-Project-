  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl font-black text-slate-900 tracking-tight">Incoming QC Dashboard</h1>
          <p className="text-slate-500 text-sm font-medium">Overview of raw material inspections</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card>
          <CardContent className="p-4 sm:p-6 flex items-center gap-4">
            ...
            <div>
              <p className="text-sm font-bold text-slate-500 uppercase">Total Inspections</p>
        ...
        <Card>
          <CardContent className="p-4 sm:p-6 flex items-center gap-4">
            ...
            <div>
              <p className="text-sm font-bold text-slate-500 uppercase">Passed</p>
        ...
        <Card>
          <CardContent className="p-4 sm:p-6 flex items-center gap-4">
            ...
            <div>
              <p className="text-sm font-bold text-slate-500 uppercase">Failed</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:p-6">
        <Card>
          <CardHeader>
            <CardTitle className="text-sm font-bold uppercase tracking-wider text-slate-700">Status Distribution</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="h-64">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-sm font-bold uppercase tracking-wider text-slate-700">Inspections By Category</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
