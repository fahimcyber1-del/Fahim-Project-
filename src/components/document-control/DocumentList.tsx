...
import { Search, Filter, AlertTriangle, Eye, Edit3, Trash2, PlusCircle, Download } from 'lucide-react';
              ...
              <div key={record.id} className="group bg-white border border-slate-200 hover:border-indigo-300 rounded-xl p-5 shadow-sm hover:shadow-md transition-all flex flex-col">
                <div className="flex justify-between items-start mb-3">
                  ...
                  <div className="flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                    ...
                    <button onClick={() => { if(window.confirm('Are you sure you want to delete this document?')) onDelete(record.id); }} className="p-1.5 text-slate-400 hover:text-rose-600 hover:bg-slate-100 rounded-md transition-colors" title="Delete">
