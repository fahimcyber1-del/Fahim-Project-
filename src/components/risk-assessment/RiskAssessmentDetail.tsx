      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:p-6">
         <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden">
               <div className="border-b border-slate-100 px-6 py-4 flex items-center gap-2 bg-slate-50">
                 ...
                 <h3 className="font-bold text-slate-800 uppercase tracking-widest text-sm">Context & Hazard</h3>
               </div>
               <div className="p-4 sm:p-6 space-y-6">
                 <div className="grid grid-cols-2 gap-4 pb-4 border-b border-slate-100">
                    ...
                    {record.category === 'Product' && record.productDetails ? (
                      <>
                        <div>
                           <p className="text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-1">Item Category</p>
                           <p className="text-sm font-medium text-slate-900">{record.productDetails.itemCategory}</p>
                        </div>
                        <div>
                 ...
                 <div>
                    <p className="text-[10px] font-bold text-rose-500 uppercase tracking-wider mb-2 flex items-center gap-1">
                      <AlertTriangle className="w-3.5 h-3.5" /> Hazard Identified
                    </p>
                    <p className="text-sm text-slate-800 leading-relaxed whitespace-pre-wrap p-4 bg-rose-50 rounded-lg border border-rose-100">
         ...
         <div className="space-y-6">
            <div className="bg-white border border-slate-200 rounded-xl shadow-sm p-4 sm:p-6">
               ...
               <div className={`p-3 rounded-lg text-center font-bold border ${getLevelColor(record.riskLevel)}`}>
